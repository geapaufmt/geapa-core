...
var CORE_MEMBER_EVOLUTION_SCHEMAS = Object.freeze({
  PESSOAS_BASE: Object.freeze([
    'PAIS_ORIGEM_CODIGO', 'PAIS_ORIGEM_NOME', 'MUNICIPIO_ORIGEM_CODIGO', 'REGIAO_ORIGEM'
  ]),
  MEMBROS_DETALHES: Object.freeze([
    'CURSO_ID', 'CURSO_NOME_SNAPSHOT', 'INSTITUICAO_ENSINO', 'CAMPUS', 'NIVEL_CURSO',
    'PERIODO_INGRESSO_CURSO', 'SEMESTRE_ATUAL_CURSO_CALCULADO',
    'SEMESTRE_ATUAL_CURSO_CALCULADO_EM', 'STATUS_COMPLETUDE_CADASTRAL',
    'COMPLETUDE_CADASTRAL_ATUALIZADA_EM'
  ]),
  CURSOS_CATALOGO: Object.freeze([
    'CURSO_ID', 'NOME_CURSO', 'INSTITUICAO', 'CAMPUS', 'NIVEL', 'AREA_GERAL',
    'ATIVO', 'ORDEM_EXIBICAO', 'PERMITE_CADASTRO', 'CRIADO_EM', 'ATUALIZADO_EM', 'OBSERVACOES'
  ]),
  INGRESSOS_MEMBROS: Object.freeze([
    'ID_INGRESSO', 'CHAVE_IDEMPOTENCIA', 'STATUS_INGRESSO', 'MODALIDADE_CADASTRO',
    'ID_PESSOA', 'ID_VINCULO', 'ID_EVENTO_INGRESSO', 'EMAIL', 'RGA', 'CURSO_ID',
    'DATA_INGRESSO', 'SEMESTRE_ENTRADA', 'FORMA_INGRESSO', 'DOCUMENTO_REFERENCIA',
    'OBS_ADMINISTRATIVA', 'ETAPA_EXECUCAO', 'ERRO_EXECUCAO', 'CRIADO_EM', 'CRIADO_POR',
    'EXECUTADO_EM', 'EXECUTADO_POR', 'ATUALIZADO_EM', 'AUDITORIA_JSON'
  ]),
  CONVITES_AVALIACAO_EGRESSOS: Object.freeze([
  ...
  RESPOSTAS_AVALIACAO_EGRESSOS: Object.freeze([
    'ID_RESPOSTA', 'ID_CONVITE', 'NOTA_GERAL', 'ASPECTOS_POSITIVOS',
    'ASPECTOS_A_MELHORAR', 'SUGESTOES', 'MOTIVO_DESLIGAMENTO_COMPLEMENTAR',
    'AUTORIZA_USO_ANONIMO', 'DEPOIMENTO_AUTORIZADO', 'RESPONDIDO_EM',
    'VERSAO_FORMULARIO', 'CRIADO_EM', 'AUDITORIA_JSON'
  ])
});
  ...
  PESSOAS: Object.freeze([
    ...
    Object.freeze({
      ...
      headers: Object.freeze([
        ...
        'CAMPUS',
        'NIVEL_CURSO',
        'PERIODO_INGRESSO_CURSO',
        'SEMESTRE_ATUAL_CURSO_CALCULADO',
        'SEMESTRE_ATUAL_CURSO_CALCULADO_EM',
        'STATUS_COMPLETUDE_CADASTRAL',
        'COMPLETUDE_CADASTRAL_ATUALIZADA_EM',
    ...
    Object.freeze({
      sheetName: 'CURSOS_CATALOGO',
      classification: 'FONTE',
      optional: true,
      headers: CORE_MEMBER_EVOLUTION_SCHEMAS.CURSOS_CATALOGO
    }),
    Object.freeze({
      sheetName: 'INGRESSOS_MEMBROS',
      classification: 'FONTE_EVENTOS',
      optional: true,
      headers: CORE_MEMBER_EVOLUTION_SCHEMAS.INGRESSOS_MEMBROS
    }),
    Object.freeze({
      sheetName: 'CONVITES_AVALIACAO_EGRESSOS',
      classification: 'FONTE_EVENTOS',
      optional: true,
      headers: CORE_MEMBER_EVOLUTION_SCHEMAS.CONVITES_AVALIACAO_EGRESSOS
    }),
    Object.freeze({
      sheetName: 'RESPOSTAS_AVALIACAO_EGRESSOS',
      classification: 'FONTE',
      optional: true,
      headers: CORE_MEMBER_EVOLUTION_SCHEMAS.RESPOSTAS_AVALIACAO_EGRESSOS
    }),
    Object.freeze({
