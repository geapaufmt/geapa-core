...
const GEAPA_CORE = Object.freeze({
  ...
  domainsV2: Object.freeze({
    ...
    pessoasListLinksPerfis: corePessoasListLinksPerfis_,
    pessoasListLinksPerfisPublicos: corePessoasListLinksPerfisPublicos_,
    pessoasPrepareLinksPerfis: corePessoasV2PrepareLinksPerfis_,
    pessoasPrepareLinksPerfisReal: corePessoasV2PrepareLinksPerfisReal_,
    pessoasMigrarLinksPerfisLegados: corePessoasV2MigrarLinksPerfisLegados_,
    pessoasMigrarLinksPerfisLegadosReal: corePessoasV2MigrarLinksPerfisLegadosReal_,
    pessoasVerificarRemocaoLinkLattesLegado: corePessoasV2VerificarRemocaoLinkLattesLegado_,
    pessoasRemoverColunaLinkLattesLegado: corePessoasV2RemoverColunaLinkLattesLegado_,
    pessoasRemoverColunaLinkLattesLegadoReal: corePessoasV2RemoverColunaLinkLattesLegadoReal_,
  ...
  portal: Object.freeze({
    ...
    buscarMeuPerfilParaPortal: core_buscarMeuPerfilParaPortal_,
    listarMembrosAdministracaoPortal: core_listarMembrosAdministracaoPortal_,
    ...
    access: Object.freeze({
      ...
      clearConfigCache: corePortalConfigCacheClear_,
      ...
      sincronizarUsuarioFirestore: corePortalSincronizarUsuarioFirestore_,
      provisionarFirestoreUserAutenticado: corePortalProvisionarFirestoreUserAutenticado_,
      marcarFirestoreUserInativoPorUid: corePortalMarcarFirestoreUserInativoPorUid_,
      invalidarCacheFirestoreUsuario: corePortalInvalidarCacheFirestoreUsuario_,
      ...
      getMeuResumo: corePortalGetMeuResumo_,
      listarApresentacoesPermitidas: corePortalListarApresentacoesPermitidas_,
      listarApresentacoesParaEgresso: corePortalListarApresentacoesParaEgresso_,
      diagnosticarPerfisEPermissoes: corePortalDiagnosticarPerfisEPermissoes_,
      prepararPortalParaV2: corePrepararPortalParaV2_,
    }),
    publicContent: Object.freeze({
      getDefinitions: corePortalPublicContentGetDefinitions_,
      ensureStructure: corePortalPublicContentEnsureStructure_,
      createSpreadsheet: corePortalPublicContentCreateSpreadsheet_,
      ensureSheets: corePortalPublicContentEnsureSheets_,
      ensureHeaders: corePortalPublicContentEnsureHeaders_,
      diagnostics: corePortalPublicContentDiagnostics_,
      readRows: corePortalPublicContentReadRows_,
      getPage: corePortalPublicContentGetPage_,
      getHome: corePortalPublicContentGetHome_,
      getSobre: corePortalPublicContentGetSobre_,
      getHistoria: corePortalPublicContentGetHistoria_,
      getParceiros: corePortalPublicContentGetParceiros_,
      getDocumentos: corePortalPublicContentGetDocumentos_,
      getConfig: corePortalPublicContentGetConfig_,
      getMidias: corePortalPublicContentGetMidias_,
      getDiretoriaComplementos: corePortalPublicContentGetDiretoriaComplementos_,
      getPessoasComplementos: corePortalPublicContentGetPessoasComplementos_,
      getGestoesComplementos: corePortalPublicContentGetGestoesComplementos_,
      getPessoasConfig: corePortalPublicContentGetPessoasConfig_,
      buildPublicSnapshot: corePortalPublicContentBuildPublicSnapshot_,
      buildPublicBoard: corePortalPublicContentBuildPublicBoard_,
    }),
  }),
